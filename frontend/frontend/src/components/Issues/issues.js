...
class IssueComments extends Component {
  ...
  AssignIssueSubmit() {
    ...
    axios({
      method: "get",
      url: `${API_URL}issues/${id}/assign/?memberId=${
        this.state.assignee
      ...
      if (res.data.Response == "User Assigned") {
        ...
        res.data.Response == "User not a team Member" ||
        res.data.Response == "User not an Admin or the project creator"
      ) {
          ...
          <div className="ui fixed inverted menu">
            <div className="ui container">
              ...
              <h2 className="header item">
                <a href={`${SITE_URL}onlogin`}>BugTracker</a>
              </h2>
          ...
          <Sidebar.Pushable style={{ marginTop: -14 }}>
            ...
            <Sidebar.Pusher>
              <div className="ui container">
                  ...
                  <div style={{ marginTop: 20 }}>
                    ...
                    <Header as="h2" style={{ marginTop: 15 }}>
                      ...
                      >
                        <Header
                          icon="browser"
                          content="Do you really want to this Issue?"
                        />
                        <Modal.Content>
                          <h4>
                            Once you delete this issue, there's no going back.
                            Please be certain. This action{" "}
                            <i>
                              <u>cannot</u>
                            </i>{" "}
                            be undone.This will permanently delete the{" "}
                            <i>
                              <u>{this.state.issue.title}</u>
                            </i>{" "}
                            issue, comments and media related with it. Please
                            type{" "}
                            <i>
                              <u>{this.state.issue.title}</u>
                            </i>{" "}
                        ...
                        <Form onSubmit={this.deleteIssueSubmit}>
                          ...
                          <Button
                            ...
                            floated="right"
                          >
                            <Icon name="checkmark" /> Submit and Delete the
                            Issue
                          </Button>
                        </Form>
                      </Modal>
                    ...
                    <Header as="h2" style={{ marginTop: 0 }}>
                      {this.state.issue.bug_status == 3 ? (
                        bug_status
                      ) : (
                        <Modal
                          trigger={
                            <span>
                              <Popup trigger={bug_status} inverted>
                                Close this Issue
                              </Popup>
                            </span>
                          }
                        ...
                        return (
                          <span style={{ margin: 5 }}>
                            <Label
                              icon={tag.icon}
                              content={tag.tagName}
                              color={this.tagColor(tag.color)}
                              href={`${SITE_URL}tags/${tag.id}`}
                              size="mini"
                            />
                          </span>
                        );
                    ...
                    <Segment vertical>
                      <Header as="h4">
                        {rep_user_name} opened this issue{" "}
                        <Moment fromNow>{this.state.issue.created_at}</Moment>
                      </Header>
                      <Header as="h4">
                        Assigned To:{" "}
                        {asgn_user_name == null ? (
                          ...
                          >
                            <Header
                              icon="browser"
                              content="Assigning the Issue to a Team Member"
                            />
                            <Modal.Content>
                              Assign this Issue to a team Member of the project
                              by selecting one of them from the list below:
                              <br />
                              <br />
                              <Form onSubmit={this.AssignIssueSubmit}>
                                <Dropdown
                                  ...
                                  selection
                                  search
                                  options={this.state.project_members.map(
                                    (user) => {
                                      return {
                                        key: user.pk,
                                        text: user.username,
                          ...
                          <Feed.Extra text>
                            <div
                              dangerouslySetInnerHTML={{
                                __html: this.state.issue.description,
                              }}
                            />
                          </Feed.Extra>
                          <br />
                      ...
                      return (
                        <Segment vertical>
                          <Feed.Event>
                            <Feed.Content>
                              <Feed.Summary>
                                <u>{comment.commented_by}</u> commented on this
                                issue
                                <Feed.Date>
                ...
                <form
                  onSubmit={(e) =>
                    this.sendCommentHandler(e, this.state.comment)
                  }
                  ...
                  >
                    ...
                    <Modal.Content>
                      <h4>
                        ...
                        issue, comments and media related with it. Please type{" "}
                        <i>
                          <u>{this.state.issue.title}</u>
                        </i>{" "}
                        to confirm.
                  ...
                  <Header floated="right">
                    ...
                    {asgn_user_name == null ? (
                      ...
                      >
                        ...
                        />
                        <Modal.Content>
                          Assign this Issue to a team Member of the project by
                          selecting one of them from the list below:
                          <br />
                          <br />
                          <Form onSubmit={this.AssignIssueSubmit}>
                            <Dropdown
            ...
            <div className="comments">
              <Segment raised>
                <Label color="purple" ribbon size="mini">
                  <h4>
                    {rep_user_name} commented on this issue{" "}
                    <Moment fromNow>{this.state.issue.created_at}</Moment>
                  </h4>
                </Label>
                <h4>
                ...
                return (
                  <Segment raised>
                    <Label color="blue" ribbon>
                      <h4>
                        {comment.commented_by} commented on this issue{" "}
                        <Moment fromNow>{comment.created_at}</Moment>
                      </h4>
                    </Label>
                    <h4>
