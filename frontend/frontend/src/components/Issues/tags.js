...
class Tags extends Component {
  ...
  statusLabel(status) {
    if (status == 1) {
      ...
      return <Label circular color="olive" empty />;
    }
    if (status == 1) {
  ...
  render() {
    const avatar = (url, firstname) => {
      if (url === "") {
        return <Avatar name={firstname} />;
      } else {
        var dp_url = "https://internet.channeli.in/" + url;
        return <Avatar src={dp_url} />;
      }
    };
                ...
                <Segment vertical>
                  <div style={{ marginTop: 20, marginBottom: 50 }}>
                    <Header as="h2">
                      ...
                      <span>
                        <Label
                          color={this.tagColor(this.state.tag.color)}
                          content={this.state.tag.tagName}
                          icon={this.state.tag.icon}
                        />
                      </span>
                      <Segment color={this.tagColor(this.state.tag.color)}>
                        {this.state.issues.map((issue) => {
                          return (
                            <Segment vertical key={issue.id}>
                              <h3>
                                {issue.bug_status == 3 ? (
                              ...
                              <div style={{ marginLeft: 20 }}>
                                ...
                                {issue.assigned_to == null ? (
                                  ...
                                  <Popup
                                    trigger={
                                      <b>{issue.assigned_to.username}</b>
                                    }
                                  >
                                    <Card>
                                      <Card.Content>
                                        <Image floated="right" circular>
                                          {avatar(
                                            issue.assigned_to.display_picture,
                                        ...
                                        <Card.Meta>
                                          Enrollment No:{" "}
                                          {issue.assigned_to.enrNo}
                                        </Card.Meta>
                                        <Card.Meta>
                                          Email: {issue.assigned_to.email}
                                        </Card.Meta>
                                        <div style={{ color: "#DC143C" }}>
                                          {issue.assigned_to.is_disabled
                                            ? "Disabled"
                                            : ""}
                                        </div>
                                      </Card.Content>
                                ...
                                >
                                  <Card>
                                    <Card.Content>
                                      <Image floated="right" circular>
                                        {avatar(
                                          issue.reported_by.display_picture,
                                      ...
                                      <Card.Meta>
                                        Enrollment No: {issue.reported_by.enrNo}
                                      </Card.Meta>
                                      <Card.Meta>
                                        Email: {issue.reported_by.email}
                                      </Card.Meta>
                                      <div style={{ color: "#DC143C" }}>
                                        {issue.reported_by.is_disabled
                                          ? "Disabled"
                                          : ""}
                                      </div>
                                    </Card.Content>
                                  ...
                                  >
                                    <Card>
                                      <Card.Content>
                                        ...
                                        <Card.Meta>
                                          {issue.project.creator.username}{" "}
                                          created this project{" "}
                                          <Moment fromNow>
                                            {issue.project.created_at}
                                          </Moment>
                                        </Card.Meta>
                                      </Card.Content>
                                    </Card>
                            ...
                            <Grid columns={2}>
                              <Grid.Row>
                                ...
                                <Grid.Column>
                                  ...
                                  <Popup
                                    trigger={
                                      <b>{issue.reported_by.username}</b>
                                    }
                                  >
                                    <Card>
                                      <Card.Content>
                              ...
                              >
                                <Card>
                                  <Card.Content>
                                    ...
                                    <Card.Meta>
                                      {this.statusLabel(issue.project.status)}{" "}
                                      {this.statusText(issue.project.status)}
                                    </Card.Meta>
                                    <Card.Meta>
                                      {issue.project.creator.username} created
                                      this project{" "}
                                      <Moment fromNow>
                                        {issue.project.created_at}
                                      </Moment>
